    ...
    return (
        <div className="group flex flex-col gap-2.5">
            ...
            >
                ...
                <div className="absolute inset-0 flex flex-col items-start justify-end px-2.5 pb-3 pt-4">
                    <div className="flex flex-col items-start gap-1 text-left drop-shadow-[0_4px_8px_rgba(0,0,0,1)]">
                        <div className="flex items-center gap-1.5 text-[9px] font-black tracking-widest uppercase">
                            <span className="text-muted-foreground">
                                EPISODIO {displayEp} -
                            </span>
                            <span className={isToday ? 'text-primary' : 'text-white'}>
                                {isToday ? 'EMITIDO' : 'PRÓXIMAMENTE'}
                            </span>
                        </div>
                        <span className="line-clamp-1 text-[12px] font-bold text-white transition-colors group-hover:text-primary">
                            {anime.name}
                        </span>
                    </div>
                </div>
